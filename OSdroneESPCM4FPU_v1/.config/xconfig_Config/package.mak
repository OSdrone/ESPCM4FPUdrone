...
override PKGDIR = xconfig_Config
...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_15.9.0.STS
...
package/%.xdc.inc package/%_xconfig_Config.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Config" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Config.pem4f

-include package/cfg/Config_pem4f.mak
-include package/cfg/Config_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Config_pem4f.dep
endif
Config.pem4f: package/cfg/Config_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Config.pem4f package/cfg/Config_pem4f.c: .libraries,em4f
endif

package/cfg/Config_pem4f.c package/cfg/Config_pem4f.h package/cfg/Config_pem4f.xdl: override _PROG_NAME := Config.xem4f
package/cfg/Config_pem4f.c: package/cfg/Config_pem4f.cfg
package/cfg/Config_pem4f.xdc.inc: package/cfg/Config_pem4f.xdl
package/cfg/Config_pem4f.xdl package/cfg/Config_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Config_pem4f.cfg
	-$(RM) package/cfg/Config_pem4f.dep
	-$(RM) package/cfg/Config_pem4f.c
	-$(RM) package/cfg/Config_pem4f.xdc.inc

clean,em4f::
	-$(RM) Config.pem4f
.executables,em4f .executables: Config.xem4f

Config.xem4f: |Config.pem4f

-include package/cfg/Config.xem4f.mak
Config.xem4f: package/cfg/Config_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/Config_pem4f.oem4f   package/cfg/Config_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Config.xem4f: export C_DIR=
Config.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Config.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Config.test test,em4f test: Config.xem4f.test

Config.xem4f.test:: Config.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Config.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Config.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Config.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Config_pem4f.oem4f,copy : package/cfg/Config_pem4f.oem4f
Config_pem4f.sem4f,copy : package/cfg/Config_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Config
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Config.tar.dep
endif
package/rel/xconfig_Config/xconfig_Config/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Config/xconfig_Config/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Config/xconfig_Config/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Config/xconfig_Config/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Config.tar: package/rel/xconfig_Config.xdc.inc package/rel/xconfig_Config/xconfig_Config/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Config.xdc.inc,package/rel/xconfig_Config.tar.dep)


release release,xconfig_Config: all xconfig_Config.tar
clean:: .clean
	-$(RM) xconfig_Config.tar
	-$(RM) package/rel/xconfig_Config.xdc.inc
	-$(RM) package/rel/xconfig_Config.tar.dep
